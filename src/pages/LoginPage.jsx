    ...
    <div className="min-h-screen bg-gym-black flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <img src="/logo.png" alt="" className="w-[800px] h-[800px] object-contain opacity-[0.03]" />
        </div>
        {/* Gradient overlays */}
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-10">
          <img src="/logo.png" alt="7Strength" className="w-24 h-24 object-contain mx-auto mb-6" />
